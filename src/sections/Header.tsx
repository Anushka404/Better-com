...
const Header = () => {
  ...
  return (
    ...
    <div className="container mx-auto flex justify-between items-center px-6 md:px-12 lg:px-16">
      ...
      {/* Right Section: Call Button, Sign In, and Menu Button */}
      <div className="flex items-center space-x-4">
        ...
        {/* Mobile Menu Button (Moved to the Right of "Sign in") */}
    ...
    {isMenuOpen && (
      <div className="absolute top-full right-0 w-full bg-white shadow-lg p-4 flex flex-col md:hidden">
