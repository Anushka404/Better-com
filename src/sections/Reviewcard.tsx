...
const ReviewSection = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center px-6 py-12 gap-6 md:gap-4 space-x-16 bg-gray-50">
      
      {/* Left: Review Image + Buttons */}
      <div className="flex flex-col items-center px-2 mx-48">
        {/* Review Card */}
        <div className="relative w-72 md:w-80 h-[500px] rounded-2xl overflow-hidden shadow-lg">
          <Image
      ...
      <div className="max-w-sm text-center md:text-left">
        ...
        <button className="mt-3 bg-green-900 text-white px-6 py-3 rounded-lg text-lg md:text-xl hover:bg-green-800 transition">
          See all our stories
        </button>
